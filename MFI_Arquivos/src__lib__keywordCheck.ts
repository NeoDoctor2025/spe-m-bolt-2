...
/** Texto normalizado para matching (lowercase, sem acento, espaços colapsados). */
...
/** Frases: [ascii_key, keyword_canônica] — ordem importa (mais específicas primeiro). */
...
/** Palavras: [ascii_key, keyword_canônica] */
...
/**
 * Verifica texto do paciente por sinais de alerta clínico.
 */
...
/** Lista para observabilidade / testes (> 20 itens). */
